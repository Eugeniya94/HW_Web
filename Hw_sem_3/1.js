...
const a = prompt('Ведите температуру в градусах Цельсия')
alert(`Цельсий: ${a}, Фаренгейт: ${Math.floor(((digitalization(a)))*100)/100}`)
// const b = digitalization(a)
// alert(`Цельсий: ${a}, Фаренгейт: ${b.toFixed(1)}`)

function digitalization(a) {
    dig = (9/5) * a + 32    
    return dig
}
